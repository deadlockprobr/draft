...
export function Footer({ showStats = false }: { showStats?: boolean }) {
    const { t } = useI18n();
    ...
    return (
        <footer className="shrink-0 border-t border-border/50 py-4">
            <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-muted-foreground">
                ...
                {showStats && stats && (stats.totalFinished > 0 || stats.usersOnline > 0) && (
                ...
                <a
                    href="https://github.com/deadlockprobr/draft"
                    target="_blank"
                    rel="noopener noreferrer"
